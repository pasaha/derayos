	 ...
	 <div class="container">
		  <div class="row">
				<div class="col-lg-4 col-md-4 col-sm-12 pm-widget-footer">
				  <h4 class="pm-services-panel-title">Заголовок</h4>
				  <p>
				  Что получите по окончанию М-К?
					Личный план развития + Пошаговая инструкция</p>
				</div>
				<div class="col-lg-8 col-md-8 col-sm-12 pm-widget-footer">
