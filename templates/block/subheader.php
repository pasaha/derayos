	 ...
	 <div class="pm-presentation-text-container">
		 <div class="pm-presentation-text">
			...
			<div class="pm-column-container pm-containerPadding60 pm-mobile-center">
			  <div class="container pm-mobile-center" style="text-align: left">
					...
					<div class="row">
						<div class="flocoll">
						 ...
						 <div class="flocoll-sub">
							  <ul class="pm-career-opening-widget-posts pm-career-opening-widget-posts_index">
								  <!-- post -->
							...
							<div class="pm-career-opening-widget-posts-sub">
								<h5 class="pm-services-panel-title">Узнайте подробности в течение 10 минут</h5>
